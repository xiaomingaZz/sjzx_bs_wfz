...
public class CourtThreadSP15  implements Callable<Map<String,Integer>>{
	private static Log logger = LogFactory.getLog(CourtThreadSP15.class);
	...
	public CourtThreadSP15(Fy fy,String dateTime, int id,Element root ) {
		super();
		this.fy = fy;
