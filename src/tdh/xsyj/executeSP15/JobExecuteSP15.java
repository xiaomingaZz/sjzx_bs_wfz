...
public class JobExecuteSP15  implements StatefulJob{
	private final static Log logger = LogFactory.getLog(JobExecuteSP15.class);
	...
	public void GenerateXmlData(Element  element){
		...
		try {
			...
			for (String key : WebContext.fyMap.keySet()) {
				...
				completionService.submit(new CourtThreadSP15(fy, tjsj, n,root));
			}
